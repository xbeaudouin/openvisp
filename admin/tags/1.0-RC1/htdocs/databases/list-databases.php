<?php
//
// File: list-databases.php
//
// Template File: list-databases.tpl
//
// Template Variables:
//
// -none-
              ...
              for ($i = 0; $i < sizeof ($list_domains); $i++)
              {
                $domain_properties[$i] = get_domain_properties ($list_domains[$i]);
								...
								if ( $mysql_admin == "1" && $postgresql_admin == "1" ){
									$domain_databases[$i] = get_databases_list ($list_domains[$i],"all");
								}
								elseif ( $mysql_admin == "1" ){
									$domain_databases[$i] = get_databases_list ($list_domains[$i],"mysql");
								}
								elseif ( $postgresql_admin == "1" ){
									$domain_databases[$i] = get_databases_list ($list_domains[$i],"postgresql");
								}
					...
					include ("../templates/databases/list-databases.tpl");
