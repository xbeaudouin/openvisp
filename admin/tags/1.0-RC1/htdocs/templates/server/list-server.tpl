			...
			for ($i = 0; $i < sizeof ($list_server); $i++)
				{
					if ((is_array ($list_server) and sizeof ($list_server) > 0))
						{
							print "<tr>\n";
							print "<td>".$list_server[$i]['name']."</td>";
							print "<td>".$list_server[$i]['desc']."</td>";
							print "<td>".$list_server[$i]['role']."</td>";
							if ( $is_technical == "1" ){
								print "<td>";
								//								print $list_server[$i]['ip']."<br/>";
 								print "public ".$list_server[$i]['public']."<br/>";
 								print "prive ".$list_server[$i]['private']."<br/>";
								print "</td>";

							}
							print "<td>".$list_server[$i]['active']."</td>";
							print "<td>";
							print "<a href=\"edit-server.php?fServer_id=".$list_server[$i]['id']."\">".$PALANG['pServer_edit']."</a> - ";
							print "<a href=\"manage-app.php?fServer_id=".$list_server[$i]['id']."\">".$PALANG['pServer_manage_application']."</a> -";
							print $PALANG['pServer_delete'];
							print "</td>";
							print "</tr>\n";
						}
				}
