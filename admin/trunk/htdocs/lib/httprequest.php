<?php
// $Id: httprequest.php,v 1.1 2006/01/02 14:35:01 kiwi Exp $
// This code is from PHP user manual... and have no license (it seems)
//
...
if (ereg ("httprequest.php", $_SERVER['PHP_SELF']))
{
