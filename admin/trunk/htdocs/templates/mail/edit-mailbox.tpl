...
?>
   ...
   <tr>
      ...
      <td>
         <?php $checked = (!empty ($tSpamreport)) ? 'checked' : ''; ?>
         <input type="checkbox" name="fSpamreport" <?php print $checked; ?> />
      </td>
      <td>
         &nbsp;
      </td>
...
?>
   <tr>
      <td>
         <?php print $PALANG['pMailfilter_active'] . ":\n"; ?>
       </td>
      <td>
         <?php $checked = (!empty ($tMailfilter)) ? 'checked' : ''; ?>
         <input type="checkbox" name="fMailfilter" <?php print $checked; ?> />
      </td>
      <td>
         &nbsp;
      </td>
...
?>
   ...
   <tr>
	 ...
	 <a href="send_quarantine.php?username=<?php echo $fUsername;?>&domain=<?php echo $fDomain;?>"><?php print $PALANG['pQuarantine_Resend_mail']; ?></a>
